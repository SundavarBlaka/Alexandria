	...
	<div class="super_container">
		...
		<div class="profile_container">
			...
			<div class="profile_modify">
				...
				<br><br>
					<form class="modify_form" name="modify_form" onsubmit="return modify()" action="loginsubmit" method="get">
			...
			<form name="logout" action="logout" method="GET" >
				<button type="submit" class="logout_btn" style="background-color: transparent; border-style: none"><h4 style=" color: #fe4c40;">Esci <i class="fa fa-sign-out"></i></h3></button>
			</form>
			</div>	
			<br>
			<br>
