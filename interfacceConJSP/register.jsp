    ...
    <div class="super_container">
        <div class="container">
            <div class="register_container" id="register">
                ...
                <form name="reg_form" action="loginsubmit" method="post" class="registration_form" onsubmit="return validateRegistration()">
                    Username:<br>
                    ...
                    <input type="text" name="date" class="reg_date" placeholder="gg/mm/aaaa"><br> Email: <br>
                    <input type="email" name="email" class="reg_email" placeholder="Email"><br> Telefono: <br>
                    <input type="tel" name="tel" class="reg_telefono" placeholder="Numero di Telefono"><br>Indirizzo: <br>
                    <input type="text" name="address" class="reg_address" placeholder="Indirizzo"><br>
                    ...
                    <input type="password" name="confirm_password" class="reg_password_confirm" placeholder="Conferma Password"><br> <br>
                    <div id="error"></div> <br>
