							...
							<nav class="navbar ">
								...
								<ul class="navbar_user ">
									...
									<li class="checkout"><a href="cart.jsp"> <i
											...
											id="checkout_items" class="checkout_items">3</span>
									</a></li>
								</ul>
				...
				<div class="row ">
					<div class="col ">
						<div class="search-container ">
							<form action="/search" method="get">
								<input class="search expandright " id="searchright "
									type="search" name="search" placeholder="Cerca... "> <label
						...
						<div class="product-grid" id="product-grid">
							...
							<div class="product-item" id="product_id">
								<div class="product">
									<div class="product_image">
										<img src=<%="images//"+r.getUrl()%> alt="Immagine non trovata!">
									</div>
									<div class="product_info ">
										<h6 class="product_name"><a onclick="$('#mostra_risorsa<%=r.getId()%>').submit()"><%=r.getTitolo()%></a></h6>
